...
#ifndef TKN_CLIENTVERSION_H
#define TKN_CLIENTVERSION_H
...
#error Client version information missing: version is not defined by tknc-build-config.h or in any other way
#endif
