...
#include <kernel/tknckernel.h>
#include <kernel/tknckernel_wrapper.h>
#include <util/fs.h>

#define BOOST_TEST_MODULE TKNC Kernel Test Suite
...
struct TestDirectory {
    ...
    TestDirectory(std::string directory_name)
        : m_directory{fs::path{fs::temp_directory_path()} / fs::u8path(directory_name + "_test_" + random_string(16))}
    {
