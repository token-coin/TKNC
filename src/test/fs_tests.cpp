...
{
    std::string u8_str = "fs_tests_é";
    std::u8string str8{u8"fs_tests_é"};
...
{
    std::string test_filename = "fs_tests_é.dat";
    std::string expected_stem = "fs_tests_é";
...
BOOST_AUTO_TEST_CASE(fsbridge_fstream)
{
    ...
    fs::path tmpfile1 = tmpfolder / fs::u8path("fs_tests_é");
    fs::path tmpfile2 = tmpfolder / fs::path(u8"fs_tests_é");
    {
    ...
    }
    {
        ...
        file >> input_buffer;
        BOOST_CHECK_EQUAL(input_buffer, "tknc");
    }
    {
    ...
    }
    {
        ...
        std::string input_buffer;
        file >> input_buffer;
        BOOST_CHECK_EQUAL(input_buffer, "tnctests");
    }
    {
    ...
    }
    {
        ...
        fs::path p = fsbridge::AbsPathJoin(tmpfolder, fs::u8path("fs_tests_é"));
