...
{
 std::string u8_str = "fs_tests_";
 std::u8string str8{u8"fs_tests_"};
...
{
 std::string test_filename = "fs_tests_.dat";
 std::string expected_stem = "fs_tests_";
...
BOOST_AUTO_TEST_CASE(fsbridge_fstream)
{
 ...
 fs::path tmpfile1 = tmpfolder / fs::u8path("fs_tests_");
 fs::path tmpfile2 = tmpfolder / fs::path(u8"fs_tests_");
 {
 ...
 fs::path p = fsbridge::AbsPathJoin(tmpfolder, fs::u8path("fs_tests_"));
