...
void OptionTests::parametersInteraction()
{
    ...
    // With fListen=false in ~/.config/TKNC/TKNC-Qt.conf and all else left as default,
    // tknc-qt should set both -listen and -listenonion to false and start successfully.
