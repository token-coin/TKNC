...
//! Entry point for TKNCApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &TKNCApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for TKNCGUI tests.
void AppTests::guiTests(TKNCGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &TKNCGUI::consoleShown, this, &AppTests::consoleTests);
