...
#ifndef TKN_QT_OPTIONSMODEL_H
#define TKN_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for TKNC client.
...
public:
    ...
    TKNCUnit getDisplayUnit() const { return m_display_tknc_unit; }
...
Q_SIGNALS:
    void displayUnitChanged(TKNCUnit unit);
