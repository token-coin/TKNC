...
#ifndef TKNC_QT_TKNCUNITS_H
#define TKNC_QT_TKNCUNITS_H
...
/** TKNC unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class TKNCUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit TKNCUnits(QObject *parent);

    /** TKNC units.
      @note Source: https://en.tknc.it/wiki/Units . Please add only sensible ones
     */
    enum class Unit {
        TKNC,
        mTKNC,
    ...
    //! Number of Tokens (1e-8) per unit
