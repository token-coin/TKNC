...
#ifndef TKN_QT_GUIUTIL_H
#define TKN_QT_GUIUTIL_H
...
/** Utility functions used by the TKNC Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "tknc:" URI into recipient object, return true on successful parsing
