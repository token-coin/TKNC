    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (about)
    {
        ...
        QString header = "The TKNC-Qt application provides a graphical interface for interacting with the TokenCoin (TKNC) network.\n\n"
                         "It combines core functionalities with a user-friendly interface for wallet management, AI model mining, and service trading.\n\n"
