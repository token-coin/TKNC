...
public:
                      ...
                      const QModelIndex &index ) const override
    {
        ...
        painter->setPen(foreground);
        QString amountText = TKNCUnits::formatWithUnit(unit, amount, true, TKNCUnits::SeparatorStyle::ALWAYS);
        if(!confirmed)
        {
...
{
    TKNCUnit unit = walletModel->getOptionsModel()->getDisplayUnit();
    ui->labelBalance->setText(TKNCUnits::formatWithPrivacy(unit, balances.balance, TKNCUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelUnconfirmed->setText(TKNCUnits::formatWithPrivacy(unit, balances.unconfirmed_balance, TKNCUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelImmature->setText(TKNCUnits::formatWithPrivacy(unit, balances.immature_balance, TKNCUnits::SeparatorStyle::ALWAYS, m_privacy));
    ui->labelTotal->setText(TKNCUnits::formatWithPrivacy(unit, balances.balance + balances.unconfirmed_balance + balances.immature_balance, TKNCUnits::SeparatorStyle::ALWAYS, m_privacy));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("TKNC")
    updateDisplayUnit();
}
