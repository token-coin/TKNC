...
#ifndef TKN_QT_TKNCGUI_H
#define TKN_QT_TKNCGUI_H
...
/**
  TKNCGUI main class. This class represents the main window of the TKNC UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class TKNCGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit TKNCGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~TKNCGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a TKNC wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, TKNCUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed TKNC Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(TKNCUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // TKN_QT_TKNCGUI_H
