      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->tkncAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->tkncAtStartup);
    ...
    ui->tkncAtStartup->setToolTip(ui->tkncAtStartup->toolTip().arg(CLIENT_NAME));
    ui->tkncAtStartup->setText(ui->tkncAtStartup->text().arg(CLIENT_NAME));

    ui->openTKNCConfButton->setToolTip(ui->openTKNCConfButton->toolTip().arg(CLIENT_NAME));
    ...
    ui->unit->setModel(new TKNCUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->tkncAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openTKNCConfButton_clicked()
{
