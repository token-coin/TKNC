...
#ifndef TKN_QT_BITCOIN_H
#define TKN_QT_BITCOIN_H
...
/** Main TKNC application object */
class TKNCApplication: public QApplication
{
    Q_OBJECT
public:
    explicit TKNCApplication();
    ~TKNCApplication();
    ...
    /// Get window identifier of QMainWindow (TKNCGUI)
...
Q_SIGNALS:
    ...
    void windowShown(TKNCGUI* window);
