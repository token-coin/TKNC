...
#ifndef TKN_TXGRAPH_H
#define TKN_TXGRAPH_H

static constexpr unsigned MAX_CLUSTER_COUNT_LIMIT{64};

/** TxGraph: fees/sizes/deps for txns, with main + optional staging graphs.
 *  Clusters = connected components (parent/child reachable). Linearization = topological order
 *  aiming for fee-maximizing mining. Chunks = highest-feerate prefixes, always connected.
 *  Refs: https://delvingbitcoin.org/t/introduction-to-cluster-linearization/1032 */
class TxGraph
{
public:
