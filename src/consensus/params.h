...
#ifndef TKN_CONSENSUS_PARAMS_H
#define TKN_CONSENSUS_PARAMS_H
...
struct Params {
    ...
    // Note: nSubsidyHalvingInterval removed — TKNC uses remaining-supply decay, not Bitcoin halving.
    /**
    ...
    /**
     * If true, witness commitments contain a payload equal to a TKNC Script solution
    ...
    int nDifficultyWindow;
    int nMaxConcurrentRequests;};

} // namespace Consensus

#endif // TKN_CONSENSUS_PARAMS_H
