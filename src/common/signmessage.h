...
#ifndef TKN_COMMON_SIGNMESSAGE_H
#define TKN_COMMON_SIGNMESSAGE_H
 ...
 * @param[in] address Signer's TKNC address, it must refer to a public key.
...
#endif // TKN_COMMON_SIGNMESSAGE_H
