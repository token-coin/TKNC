...
#ifndef TKN_CHAINPARAMSBASE_H
#define TKN_CHAINPARAMSBASE_H
...
/** CBaseChainParams defines the base parameters (shared between tknc-cli and tkncd) of a given instance of the TKNC system. */
