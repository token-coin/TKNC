...
/** Parse a DER-like ECPrivateKey encoding (SEC 1 C.4): SEQUENCE length is 1-2 octets (not strict DER), privateKey is zero-filled to 32 bytes, trailing data is ignored. out32 must be ?2 bytes. */
