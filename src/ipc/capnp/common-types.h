...
#ifndef TKN_IPC_CAPNP_COMMON_TYPES_H
#define TKN_IPC_CAPNP_COMMON_TYPES_H
...
//! needed to pass transaction objects between TKNC processes.
...
//! Functions to serialize / deserialize common TKNC types.
namespace mp {
...
#endif // TKN_IPC_CAPNP_COMMON_TYPES_H
