...
constexpr uint8_t DB_ADDRESSINDEX_UTXO{'a'};      // UTXO index: scriptHash → UTXO data
constexpr uint8_t DB_ADDRESSINDEX_OUTPOINT{'o'};  // Outpoint index: outpoint → scriptHash
