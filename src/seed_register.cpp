...
// Context for HTTP callbacks — response data captured DURING callback (req still valid)
...
static std::string GetBestPublicIP()
{
    ...
    // Skip IPv6 interface enumeration — EUI-64 addresses are unreachable from WAN.
