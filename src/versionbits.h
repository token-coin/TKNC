...
#ifndef TKN_VERSIONBITS_H
#define TKN_VERSIONBITS_H
...
// Map giving the state for blocks whose height is a multiple of Period(). Indexed by the block's parent, so all keys are nullptr or a block with (height + 1) % Period() == 0.
