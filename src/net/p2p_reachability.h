...
// ============================================================
// P2PReachability — Node-embedded NAT traversal + hole punching
//
// Architecture:
//   1. DetectNATType()       → classify our NAT behavior
//   2. CoordinatePunch()     → coordinated UDP hole punch with remote peer
//   3. TryTCPFallback()      → TCP connect if UDP fails
//   4. MaintainSessions()    → heartbeat + expiry for established sessions
//
// Integration points:
