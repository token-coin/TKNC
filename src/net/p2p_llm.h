...
struct P2PLLMHandshakeReq {
 ...
 int64_t client_tokens_per_tknc; // Client's expected tokens_per_tknc (for comparison)

 P2PLLMHandshakeReq() : client_tokens_per_tknc(0) {}
...
struct P2PLLMHandshakeResp {
 ...
 int64_t verified_tokens_per_tknc;// Node-verified real exchange rate (tokens per TKNC)
 int64_t tokens_per_tknc; // Same as verified_tokens_per_tknc (kept for binary compat)
 ...
 verified_tokens_per_tknc(0), tokens_per_tknc(0) {}
