...
// ============================================================
// PeerSession — Tracks a direct connection between two nodes
//
// Lifecycle:
//   ESTABLISHED → ACTIVE (heartbeat) → IDLE → EXPIRED
//                                    ↘ ERROR
//
...
enum class SessionState : int {
    ...
    EXPIRED,         // Timed out — needs re-establishment
...
// ============================================================
// PeerSessionManager — Container for all active sessions
//
...
public:
     ...
     * Core binding point: ensures endpoint→session is always connected.
