...
#ifndef TKN_RPC_UTIL_H
#define TKN_RPC_UTIL_H
...
/**
 * Parse a json number or string, denoting TKNC/kvB, into a CFeeRate (sat/kvB).
 * Reject negative values or rates larger than 1TKNC/kvB.
 */
