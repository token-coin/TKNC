...
#ifndef TKN_RPC_REGISTER_H
#define TKN_RPC_REGISTER_H
...
static inline void RegisterAllCoreRPCCommands(CRPCTable &t)
{
    ...
    RegisterTKNCAPIKeyRPCCommands(t);
    RegisterEscrowRPCCommands(t);
    RegisterModelRegistryRPCCommands(t);
}

#endif // TKN_RPC_REGISTER_H
