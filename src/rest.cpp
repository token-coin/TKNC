...
// Get the node context. Sets req status code if not found. Returns pointer or nullptr.
...
// Get the node context mempool. Sets req status code if not found. Returns pointer or nullptr.
...
// Get the node context chainstatemanager. Sets req status code if not found. Returns pointer or nullptr.
...
// Handler for multiple endpoints: /block/ (rest_block_extended), /block/notxdetails/ (rest_block_notxdetails), /blockpart/ (rest_block_part, no JSON, tx_verbosity unset).
