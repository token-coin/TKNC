...
RPCMethod sendtoaddress()
{
 ...
 {
 {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The TKNC address to send to."},
 ...
 "The recipient will receive less TKNC than you enter in the amount field."},
 ...
 "\nSend 0.1 TKNC with a confirmation target of 6 blocks in economical fee estimate mode using positional arguments\n"
 + HelpExampleCli("sendtoaddress", "\"" + EXAMPLE_ADDRESS[0] + "\" 0.1 \"donation\" \"sean's outpost\" false true 6 economical") +
 "\nSend 0.1 TKNC with a fee rate of 1.1 " + CURRENCY_ATOM + "/vB, subtract fee from amount, BIP125-replaceable, using positional arguments\n"
 + HelpExampleCli("sendtoaddress", "\"" + EXAMPLE_ADDRESS[0] + "\" 0.1 \"drinks\" \"room77\" true true null \"unset\" null 1.1") +
 "\nSend 0.2 TKNC with a confirmation target of 6 blocks in economical fee estimate mode using named arguments\n"
 + HelpExampleCli("-named sendtoaddress", "address=\"" + EXAMPLE_ADDRESS[0] + "\" amount=0.2 conf_target=6 estimate_mode=\"economical\"") +
 "\nSend 0.5 TKNC with a fee rate of 25 " + CURRENCY_ATOM + "/vB using named arguments\n"
...
RPCMethod sendmany()
{
 ...
 {
 {"address", RPCArg::Type::AMOUNT, RPCArg::Optional::NO, "The TKNC address is the key, the numeric amount (can be string) in " + CURRENCY_UNIT + " is the value"},
 },
 },
 ...
 "Those recipients will receive less TKNC than you enter in their corresponding amount field.\n"
...
CreatedTransactionResult FundTransaction(CWallet& wallet, const CMutableTransaction& tx, const std::vector<CRecipient>& recipients, const UniValue& options, CCoinControl& coinControl, bool override_min_fee)
{
 ...
 throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Change address must be a valid TKNC address");
 }
...
RPCMethod fundrawtransaction()
{
 ...
 {"changeAddress", RPCArg::Type::STR, RPCArg::DefaultHint{"automatic"}, "The TKNC address to receive the change"},
...
static std::vector<RPCArg> OutputsDoc()
{
 ...
 {
 {"address", RPCArg::Type::AMOUNT, RPCArg::Optional::NO, "A key-value pair. The key (string) is the TKNC address,\n"
...
static RPCMethod bumpfee_helper(std::string method_name)
{
 ...
 "original change output. The change output amount can increase if bumping the transaction "
...
RPCMethod send()
{
 ...
 {"change_address", RPCArg::Type::STR, RPCArg::DefaultHint{"automatic"}, "The TKNC address to receive the change"},
 ...
 RPCExamples{""
 "\nSend 0.1 TKNC with a confirmation target of 6 blocks in economical fee estimate mode\n"
 + HelpExampleCli("send", "'{\"" + EXAMPLE_ADDRESS[0] + "\": 0.1}' 6 economical\n") +
 "Send 0.2 TKNC with a fee rate of 1.1 " + CURRENCY_ATOM + "/vB using positional arguments\n"
 + HelpExampleCli("send", "'{\"" + EXAMPLE_ADDRESS[0] + "\": 0.2}' null \"unset\" 1.1\n") +
 "Send 0.2 TKNC with a fee rate of 1 " + CURRENCY_ATOM + "/vB using the options argument\n"
 + HelpExampleCli("send", "'{\"" + EXAMPLE_ADDRESS[0] + "\": 0.2}' null \"unset\" null '{\"fee_rate\": 1}'\n") +
 "Send 0.3 TKNC with a fee rate of 25 " + CURRENCY_ATOM + "/vB using named arguments\n"
...
RPCMethod sendall()
{
 ...
 {
 {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "A TKNC address which receives an equal share of the unspecified amount."},
 {"", RPCArg::Type::OBJ_USER_KEYS, RPCArg::Optional::OMITTED, "",
 {
 {"address", RPCArg::Type::AMOUNT, RPCArg::Optional::NO, "A key-value pair. The key (string) is the TKNC address, the value (float or string) is the amount in " + CURRENCY_UNIT + ""},
 },
 },
 },
 },
...
RPCMethod walletcreatefundedpsbt()
{
 ...
 RPCExamples{
 "\nCreate a PSBT with automatically picked inputs that sends 0.5 TKNC to an address and has a fee rate of 2 sat/vB:\n"
