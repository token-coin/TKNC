...
BOOST_AUTO_TEST_CASE(bnb_test)
{
    for (int feerate : FEERATES) {
         ...
         * is 8 CENT while all UTXOs are slightly bigger than 1 CENT. The smallest eight are 100,000...00,007 sats, while
         * the larger nine are 100,368...00,375 (i.e., 100,008...00,016 sats plus cost_of_change (359 sats)).
         *
