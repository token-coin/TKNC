...
#ifndef TKN_WALLET_SCRIPTPUBKEYMAN_H
#define TKN_WALLET_SCRIPTPUBKEYMAN_H
...
public:
    ...
    virtual SigningResult SignMessage(const std::string& message, const WitnessV0KeyHash& wpkhash, std::string& str_sig) const { return SigningResult::SIGNING_FAILED; };
    ...
    /** Birth time changed */
    tkncsignals::signal<void (const ScriptPubKeyMan* spkm, int64_t new_birth_time)> NotifyFirstKeyTimeChanged;
};
...
public:
    ...
    SigningResult SignMessage(const std::string& message, const WitnessV0KeyHash& wpkhash, std::string& str_sig) const override;
...
#endif // TKN_WALLET_SCRIPTPUBKEYMAN_H
