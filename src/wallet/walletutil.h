...
#ifndef TKN_WALLET_WALLETUTIL_H
#define TKN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! tkncd from opening the wallet, thinking it was newly created, and
