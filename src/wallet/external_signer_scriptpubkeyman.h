...
#ifndef TKN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define TKN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // TKN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
