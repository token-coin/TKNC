...
#ifndef TKN_PRIVATE_BROADCAST_H
#define TKN_PRIVATE_BROADCAST_H
...
/** Store transactions for private broadcast. Operations: add, remove, pick-for-recipient,
 *  query-picked, mark-received, query-received, query-any-pending. */
...
public:
    ...
    /** Pick most urgent txn (fewest send attempts/confirmations, oldest times). Remembers node+address as send target. Returns nullopt if empty. */
