...
#ifndef TKN_KERNEL_TKNCKERNEL_H
#define TKN_KERNEL_TKNCKERNEL_H
...
#ifndef TKNCKERNEL_API
    #ifdef TKNCKERNEL_BUILD
        #if defined(_WIN32)
            #define TKNCKERNEL_API __declspec(dllexport)
        #else
            #define TKNCKERNEL_API __attribute__((visibility("default")))
        #endif
    #else
        #if defined(_WIN32) && !defined(TKNCKERNEL_STATIC)
            #define TKNCKERNEL_API __declspec(dllimport)
        #else
            #define TKNCKERNEL_API
        #endif
    #endif
#endif
...
/* Warning attributes */
#if defined(__GNUC__)
    #define TKNCKERNEL_WARN_UNUSED_RESULT __attribute__((__warn_unused_result__))
#else
    #define TKNCKERNEL_WARN_UNUSED_RESULT
#endif

/**
 * TKNCKERNEL_ARG_NONNULL is a compiler attribute used to indicate that
 ...
 */
#if !defined(TKNCKERNEL_BUILD) && defined(__GNUC__)
    #define TKNCKERNEL_ARG_NONNULL(...) __attribute__((__nonnull__(__VA_ARGS__)))
#else
    #define TKNCKERNEL_ARG_NONNULL(...)
#endif
 ...
 *
 * This header currently exposes an API for interacting with parts of TKNC
 ...
 * also not yet included in releases of TKNC Core.
 *
...
/**
 * Function signature for the global logging callback. All TKNC kernel
 ...
 */
TKNCKERNEL_API btck_Transaction* TKNCKERNEL_WARN_UNUSED_RESULT btck_transaction_create(
 ...
 */
TKNCKERNEL_API btck_Transaction* TKNCKERNEL_WARN_UNUSED_RESULT btck_transaction_copy(
    const btck_Transaction* transaction) TKNCKERNEL_ARG_NONNULL(1);
 ...
 * @return                0 on success.
 */
TKNCKERNEL_API int btck_transaction_to_bytes(
    const btck_Transaction* transaction,
    btck_WriteBytes writer,
    void* user_data) TKNCKERNEL_ARG_NONNULL(1, 2);
 ...
 */
TKNCKERNEL_API size_t TKNCKERNEL_WARN_UNUSED_RESULT btck_transaction_count_outputs(
    const btck_Transaction* transaction) TKNCKERNEL_ARG_NONNULL(1);
 ...
 */
TKNCKERNEL_API const btck_TransactionOutput* TKNCKERNEL_WARN_UNUSED_RESULT btck_transaction_get_output_at(
    const btck_Transaction* transaction, size_t output_index) TKNCKERNEL_ARG_NONNULL(1);
 ...
 */
TKNCKERNEL_API const btck_TransactionInput* TKNCKERNEL_WARN_UNUSED_RESULT btck_transaction_get_input_at(
    const btck_Transaction* transaction, size_t input_index) TKNCKERNEL_ARG_NONNULL(1);
 ...
 */
TKNCKERNEL_API size_t TKNCKERNEL_WARN_UNUSED_RESULT btck_transaction_count_inputs(
    const btck_Transaction* transaction) TKNCKERNEL_ARG_NONNULL(1);
 ...
 */
TKNCKERNEL_API uint32_t TKNCKERNEL_WARN_UNUSED_RESULT btck_transaction_get_locktime(
    const btck_Transaction* transaction) TKNCKERNEL_ARG_NONNULL(1);
 ...
 * @return                The txid.
 */
TKNCKERNEL_API const btck_Txid* TKNCKERNEL_WARN_UNUSED_RESULT btck_transaction_get_txid(
    const btck_Transaction* transaction) TKNCKERNEL_ARG_NONNULL(1);

/**
 * Destroy the transaction.
 */
TKNCKERNEL_API void btck_transaction_destroy(btck_Transaction* transaction);
 ...
 */
TKNCKERNEL_API btck_PrecomputedTransactionData* TKNCKERNEL_WARN_UNUSED_RESULT btck_precomputed_transaction_data_create(
    const btck_Transaction* tx_to,
    const btck_TransactionOutput** spent_outputs, size_t spent_outputs_len) TKNCKERNEL_ARG_NONNULL(1);
 ...
 */
TKNCKERNEL_API btck_PrecomputedTransactionData* TKNCKERNEL_WARN_UNUSED_RESULT btck_precomputed_transaction_data_copy(
    const btck_PrecomputedTransactionData* precomputed_txdata) TKNCKERNEL_ARG_NONNULL(1);

/**
 * Destroy the precomputed transaction data.
 */
TKNCKERNEL_API void btck_precomputed_transaction_data_destroy(btck_PrecomputedTransactionData* precomputed_txdata);
 ...
 */
TKNCKERNEL_API btck_ScriptPubkey* TKNCKERNEL_WARN_UNUSED_RESULT btck_script_pubkey_create(
 ...
 */
TKNCKERNEL_API btck_ScriptPubkey* TKNCKERNEL_WARN_UNUSED_RESULT btck_script_pubkey_copy(
    const btck_ScriptPubkey* script_pubkey) TKNCKERNEL_ARG_NONNULL(1);
 ...
 */
TKNCKERNEL_API int TKNCKERNEL_WARN_UNUSED_RESULT btck_script_pubkey_verify(
    ...
    btck_ScriptVerifyStatus* status) TKNCKERNEL_ARG_NONNULL(1, 3);
 ...
 * @return                  0 on success.
 */
TKNCKERNEL_API int btck_script_pubkey_to_bytes(
    const btck_ScriptPubkey* script_pubkey,
    btck_WriteBytes writer,
    void* user_data) TKNCKERNEL_ARG_NONNULL(1, 2);
 ...
 */
TKNCKERNEL_API void btck_script_pubkey_destroy(btck_ScriptPubkey* script_pubkey);
 ...
 * @return                  The transaction output.
 */
TKNCKERNEL_API btck_TransactionOutput* TKNCKERNEL_WARN_UNUSED_RESULT btck_transaction_output_create(
    const btck_ScriptPubkey* script_pubkey,
    int64_t amount) TKNCKERNEL_ARG_NONNULL(1);
 ...
 * @return                       The script pubkey.
 */
TKNCKERNEL_API const btck_ScriptPubkey* TKNCKERNEL_WARN_UNUSED_RESULT btck_transaction_output_get_script_pubkey(
    const btck_TransactionOutput* transaction_output) TKNCKERNEL_ARG_NONNULL(1);
 ...
 * @return                       The amount.
 */
TKNCKERNEL_API int64_t TKNCKERNEL_WARN_UNUSED_RESULT btck_transaction_output_get_amount(
    const btck_TransactionOutput* transaction_output) TKNCKERNEL_ARG_NONNULL(1);
 ...
 */
TKNCKERNEL_API btck_TransactionOutput* TKNCKERNEL_WARN_UNUSED_RESULT btck_transaction_output_copy(
    const btck_TransactionOutput* transaction_output) TKNCKERNEL_ARG_NONNULL(1);

/**
 * Destroy the transaction output.
 */
TKNCKERNEL_API void btck_transaction_output_destroy(btck_TransactionOutput* transaction_output);
 ...
 * already exists.
 */
TKNCKERNEL_API void btck_logging_disable();
 ...
 */
TKNCKERNEL_API void btck_logging_set_options(btck_LoggingOptions options);
 ...
 */
TKNCKERNEL_API void btck_logging_set_level_category(btck_LogCategory category, btck_LogLevel level);
 ...
 */
TKNCKERNEL_API void btck_logging_enable_category(btck_LogCategory category);
 ...
 */
TKNCKERNEL_API void btck_logging_disable_category(btck_LogCategory category);
 ...
 */
TKNCKERNEL_API btck_LoggingConnection* TKNCKERNEL_WARN_UNUSED_RESULT btck_logging_connection_create(
    btck_LogCallback log_callback,
    void* user_data,
    btck_DestroyCallback user_data_destroy_callback) TKNCKERNEL_ARG_NONNULL(1);

/**
 * Stop logging and destroy the logging connection.
 */
TKNCKERNEL_API void btck_logging_connection_destroy(btck_LoggingConnection* logging_connection);
 ...
 */
TKNCKERNEL_API btck_ChainParameters* TKNCKERNEL_WARN_UNUSED_RESULT btck_chain_parameters_create(
    btck_ChainType chain_type);

/**
 * Copy the chain parameters.
 */
TKNCKERNEL_API btck_ChainParameters* TKNCKERNEL_WARN_UNUSED_RESULT btck_chain_parameters_copy(
    const btck_ChainParameters* chain_parameters) TKNCKERNEL_ARG_NONNULL(1);
 ...
 */
TKNCKERNEL_API const btck_ConsensusParams* TKNCKERNEL_WARN_UNUSED_RESULT btck_chain_parameters_get_consensus_params(
    const btck_ChainParameters* chain_parameters) TKNCKERNEL_ARG_NONNULL(1);

/**
 * Destroy the chain parameters.
 */
TKNCKERNEL_API void btck_chain_parameters_destroy(btck_ChainParameters* chain_parameters);
 ...
 */
TKNCKERNEL_API btck_ContextOptions* TKNCKERNEL_WARN_UNUSED_RESULT btck_context_options_create();
 ...
 */
TKNCKERNEL_API void btck_context_options_set_chainparams(
    btck_ContextOptions* context_options,
    const btck_ChainParameters* chain_parameters) TKNCKERNEL_ARG_NONNULL(1, 2);
 ...
 */
TKNCKERNEL_API void btck_context_options_set_notifications(
    btck_ContextOptions* context_options,
    btck_NotificationInterfaceCallbacks notifications) TKNCKERNEL_ARG_NONNULL(1);
 ...
 *                                           user.
 */
TKNCKERNEL_API void btck_context_options_set_validation_interface(
    btck_ContextOptions* context_options,
    btck_ValidationInterfaceCallbacks validation_interface_callbacks) TKNCKERNEL_ARG_NONNULL(1);

/**
 * Destroy the context options.
 */
TKNCKERNEL_API void btck_context_options_destroy(btck_ContextOptions* context_options);
 ...
 */
TKNCKERNEL_API btck_Context* TKNCKERNEL_WARN_UNUSED_RESULT btck_context_create(
    const btck_ContextOptions* context_options);

/**
 * Copy the context.
 */
TKNCKERNEL_API btck_Context* TKNCKERNEL_WARN_UNUSED_RESULT btck_context_copy(
    const btck_Context* context) TKNCKERNEL_ARG_NONNULL(1);
 ...
 */
TKNCKERNEL_API int TKNCKERNEL_WARN_UNUSED_RESULT btck_context_interrupt(
    btck_Context* context) TKNCKERNEL_ARG_NONNULL(1);

/**
 * Destroy the context.
 */
TKNCKERNEL_API void btck_context_destroy(btck_Context* context);
 ...
 */
TKNCKERNEL_API const btck_BlockTreeEntry* TKNCKERNEL_WARN_UNUSED_RESULT btck_block_tree_entry_get_previous(
    const btck_BlockTreeEntry* block_tree_entry) TKNCKERNEL_ARG_NONNULL(1);
 ...
 */
TKNCKERNEL_API btck_BlockHeader* TKNCKERNEL_WARN_UNUSED_RESULT btck_block_tree_entry_get_block_header(
    const btck_BlockTreeEntry* block_tree_entry) TKNCKERNEL_ARG_NONNULL(1);
 ...
 */
TKNCKERNEL_API int32_t TKNCKERNEL_WARN_UNUSED_RESULT btck_block_tree_entry_get_height(
    const btck_BlockTreeEntry* block_tree_entry) TKNCKERNEL_ARG_NONNULL(1);
 ...
 */
TKNCKERNEL_API const btck_BlockHash* TKNCKERNEL_WARN_UNUSED_RESULT btck_block_tree_entry_get_block_hash(
    const btck_BlockTreeEntry* block_tree_entry) TKNCKERNEL_ARG_NONNULL(1);
 ...
 */
TKNCKERNEL_API int TKNCKERNEL_WARN_UNUSED_RESULT btck_block_tree_entry_equals(
    const btck_BlockTreeEntry* entry1, const btck_BlockTreeEntry* entry2) TKNCKERNEL_ARG_NONNULL(1, 2);
 ...
 */
TKNCKERNEL_API const btck_BlockTreeEntry* TKNCKERNEL_WARN_UNUSED_RESULT btck_block_tree_entry_get_ancestor(
    const btck_BlockTreeEntry* block_tree_entry,
    int32_t height) TKNCKERNEL_ARG_NONNULL(1);
 ...
 */
TKNCKERNEL_API btck_ChainstateManagerOptions* TKNCKERNEL_WARN_UNUSED_RESULT btck_chainstate_manager_options_create(
    const btck_Context* context,
    const char* data_directory,
    size_t data_directory_len,
    const char* blocks_directory,
    size_t blocks_directory_len) TKNCKERNEL_ARG_NONNULL(1);
 ...
 */
TKNCKERNEL_API void btck_chainstate_manager_options_set_worker_threads_num(
    btck_ChainstateManagerOptions* chainstate_manager_options,
    int worker_threads) TKNCKERNEL_ARG_NONNULL(1);
 ...
 */
TKNCKERNEL_API int TKNCKERNEL_WARN_UNUSED_RESULT btck_chainstate_manager_options_set_wipe_dbs(
    btck_ChainstateManagerOptions* chainstate_manager_options,
    int wipe_block_tree_db,
    int wipe_chainstate_db) TKNCKERNEL_ARG_NONNULL(1);
 ...
 */
TKNCKERNEL_API void btck_chainstate_manager_options_update_block_tree_db_in_memory(
    btck_ChainstateManagerOptions* chainstate_manager_options,
    int block_tree_db_in_memory) TKNCKERNEL_ARG_NONNULL(1);
 ...
 */
TKNCKERNEL_API void btck_chainstate_manager_options_update_chainstate_db_in_memory(
    btck_ChainstateManagerOptions* chainstate_manager_options,
    int chainstate_db_in_memory) TKNCKERNEL_ARG_NONNULL(1);

/**
 * Destroy the chainstate manager options.
 */
TKNCKERNEL_API void btck_chainstate_manager_options_destroy(btck_ChainstateManagerOptions* chainstate_manager_options);
 ...
 */
TKNCKERNEL_API btck_ChainstateManager* TKNCKERNEL_WARN_UNUSED_RESULT btck_chainstate_manager_create(
    const btck_ChainstateManagerOptions* chainstate_manager_options) TKNCKERNEL_ARG_NONNULL(1);
 ...
 */
TKNCKERNEL_API const btck_BlockTreeEntry* TKNCKERNEL_WARN_UNUSED_RESULT btck_chainstate_manager_get_best_entry(
    const btck_ChainstateManager* chainstate_manager) TKNCKERNEL_ARG_NONNULL(1);
 ...
 */
TKNCKERNEL_API int TKNCKERNEL_WARN_UNUSED_RESULT btck_chainstate_manager_process_block_header(
    btck_ChainstateManager* chainstate_manager,
    const btck_BlockHeader* header,
    btck_BlockValidationState* block_validation_state) TKNCKERNEL_ARG_NONNULL(1, 2, 3);
 ...
 */
TKNCKERNEL_API int TKNCKERNEL_WARN_UNUSED_RESULT btck_chainstate_manager_import_blocks(
    btck_ChainstateManager* chainstate_manager,
    const char** block_file_paths_data, size_t* block_file_paths_lens,
    size_t block_file_paths_data_len) TKNCKERNEL_ARG_NONNULL(1);
 ...
 */
TKNCKERNEL_API int TKNCKERNEL_WARN_UNUSED_RESULT btck_chainstate_manager_process_block(
    btck_ChainstateManager* chainstate_manager,
    const btck_Block* block,
    int* new_block) TKNCKERNEL_ARG_NONNULL(1, 2, 3);
 ...
 * @return                       The chain.
 */
TKNCKERNEL_API const btck_Chain* TKNCKERNEL_WARN_UNUSED_RESULT btck_chainstate_manager_get_active_chain(
    const btck_ChainstateManager* chainstate_manager) TKNCKERNEL_ARG_NONNULL(1);
 ...
 */
TKNCKERNEL_API const btck_BlockTreeEntry* TKNCKERNEL_WARN_UNUSED_RESULT btck_chainstate_manager_get_block_tree_entry_by_hash(
    const btck_ChainstateManager* chainstate_manager,
    const btck_BlockHash* block_hash) TKNCKERNEL_ARG_NONNULL(1, 2);

/**
 * Destroy the chainstate manager.
 */
TKNCKERNEL_API void btck_chainstate_manager_destroy(btck_ChainstateManager* chainstate_manager);
 ...
 */
TKNCKERNEL_API btck_Block* TKNCKERNEL_WARN_UNUSED_RESULT btck_block_read(
    const btck_ChainstateManager* chainstate_manager,
    const btck_BlockTreeEntry* block_tree_entry) TKNCKERNEL_ARG_NONNULL(1, 2);
 ...
 */
TKNCKERNEL_API btck_Block* TKNCKERNEL_WARN_UNUSED_RESULT btck_block_create(
 ...
 */
TKNCKERNEL_API btck_Block* TKNCKERNEL_WARN_UNUSED_RESULT btck_block_copy(
    const btck_Block* block) TKNCKERNEL_ARG_NONNULL(1);
 ...
 */
TKNCKERNEL_API int TKNCKERNEL_WARN_UNUSED_RESULT btck_block_check(
    const btck_Block* block,
    const btck_ConsensusParams* consensus_params,
    btck_BlockCheckFlags flags,
    btck_BlockValidationState* validation_state) TKNCKERNEL_ARG_NONNULL(1, 2, 4);
 ...
 */
TKNCKERNEL_API size_t TKNCKERNEL_WARN_UNUSED_RESULT btck_block_count_transactions(
    const btck_Block* block) TKNCKERNEL_ARG_NONNULL(1);
 ...
 */
TKNCKERNEL_API const btck_Transaction* TKNCKERNEL_WARN_UNUSED_RESULT btck_block_get_transaction_at(
    const btck_Block* block, size_t transaction_index) TKNCKERNEL_ARG_NONNULL(1);
 ...
 * @return          btck_BlockHeader.
 */
TKNCKERNEL_API btck_BlockHeader* TKNCKERNEL_WARN_UNUSED_RESULT btck_block_get_header(
    const btck_Block* block) TKNCKERNEL_ARG_NONNULL(1);
 ...
 * @return    The block hash.
 */
TKNCKERNEL_API btck_BlockHash* TKNCKERNEL_WARN_UNUSED_RESULT btck_block_get_hash(
    const btck_Block* block) TKNCKERNEL_ARG_NONNULL(1);
 ...
 * @return              0 on success.
 */
TKNCKERNEL_API int btck_block_to_bytes(
    const btck_Block* block,
    btck_WriteBytes writer,
    void* user_data) TKNCKERNEL_ARG_NONNULL(1, 2);
 ...
 * Destroy the block.
 */
TKNCKERNEL_API void btck_block_destroy(btck_Block* block);
 ...
 */
TKNCKERNEL_API btck_BlockValidationState* TKNCKERNEL_WARN_UNUSED_RESULT btck_block_validation_state_create();

/**
 * Returns the validation mode from an opaque btck_BlockValidationState pointer.
 */
TKNCKERNEL_API btck_ValidationMode btck_block_validation_state_get_validation_mode(
    const btck_BlockValidationState* block_validation_state) TKNCKERNEL_ARG_NONNULL(1);

/**
 * Returns the validation result from an opaque btck_BlockValidationState pointer.
 */
TKNCKERNEL_API btck_BlockValidationResult btck_block_validation_state_get_block_validation_result(
    const btck_BlockValidationState* block_validation_state) TKNCKERNEL_ARG_NONNULL(1);
 ...
 */
TKNCKERNEL_API btck_BlockValidationState* TKNCKERNEL_WARN_UNUSED_RESULT btck_block_validation_state_copy(
    const btck_BlockValidationState* block_validation_state) TKNCKERNEL_ARG_NONNULL(1);

/**
 * Destroy the btck_BlockValidationState.
 */
TKNCKERNEL_API void btck_block_validation_state_destroy(
 ...
 */
TKNCKERNEL_API int32_t TKNCKERNEL_WARN_UNUSED_RESULT btck_chain_get_height(
    const btck_Chain* chain) TKNCKERNEL_ARG_NONNULL(1);
 ...
 */
TKNCKERNEL_API const btck_BlockTreeEntry* TKNCKERNEL_WARN_UNUSED_RESULT btck_chain_get_by_height(
    const btck_Chain* chain,
    int32_t block_height) TKNCKERNEL_ARG_NONNULL(1);
 ...
 *
 */
TKNCKERNEL_API int TKNCKERNEL_WARN_UNUSED_RESULT btck_chain_contains(
    const btck_Chain* chain,
    const btck_BlockTreeEntry* block_tree_entry) TKNCKERNEL_ARG_NONNULL(1, 2);
 ...
 */
TKNCKERNEL_API btck_BlockSpentOutputs* TKNCKERNEL_WARN_UNUSED_RESULT btck_block_spent_outputs_read(
    const btck_ChainstateManager* chainstate_manager,
    const btck_BlockTreeEntry* block_tree_entry) TKNCKERNEL_ARG_NONNULL(1, 2);
 ...
 */
TKNCKERNEL_API btck_BlockSpentOutputs* TKNCKERNEL_WARN_UNUSED_RESULT btck_block_spent_outputs_copy(
    const btck_BlockSpentOutputs* block_spent_outputs) TKNCKERNEL_ARG_NONNULL(1);
 ...
 */
TKNCKERNEL_API size_t TKNCKERNEL_WARN_UNUSED_RESULT btck_block_spent_outputs_count(
    const btck_BlockSpentOutputs* block_spent_outputs) TKNCKERNEL_ARG_NONNULL(1);
 ...
 */
TKNCKERNEL_API const btck_TransactionSpentOutputs* TKNCKERNEL_WARN_UNUSED_RESULT btck_block_spent_outputs_get_transaction_spent_outputs_at(
    const btck_BlockSpentOutputs* block_spent_outputs,
    size_t transaction_spent_outputs_index) TKNCKERNEL_ARG_NONNULL(1);

/**
 * Destroy the block spent outputs.
 */
TKNCKERNEL_API void btck_block_spent_outputs_destroy(btck_BlockSpentOutputs* block_spent_outputs);
 ...
 */
TKNCKERNEL_API btck_TransactionSpentOutputs* TKNCKERNEL_WARN_UNUSED_RESULT btck_transaction_spent_outputs_copy(
    const btck_TransactionSpentOutputs* transaction_spent_outputs) TKNCKERNEL_ARG_NONNULL(1);
 ...
 */
TKNCKERNEL_API size_t TKNCKERNEL_WARN_UNUSED_RESULT btck_transaction_spent_outputs_count(
    const btck_TransactionSpentOutputs* transaction_spent_outputs) TKNCKERNEL_ARG_NONNULL(1);
 ...
 */
TKNCKERNEL_API const btck_Coin* TKNCKERNEL_WARN_UNUSED_RESULT btck_transaction_spent_outputs_get_coin_at(
    const btck_TransactionSpentOutputs* transaction_spent_outputs,
    size_t coin_index) TKNCKERNEL_ARG_NONNULL(1);

/**
 * Destroy the transaction spent outputs.
 */
TKNCKERNEL_API void btck_transaction_spent_outputs_destroy(btck_TransactionSpentOutputs* transaction_spent_outputs);
 ...
 */
TKNCKERNEL_API btck_TransactionInput* TKNCKERNEL_WARN_UNUSED_RESULT btck_transaction_input_copy(
    const btck_TransactionInput* transaction_input) TKNCKERNEL_ARG_NONNULL(1);
 ...
 */
TKNCKERNEL_API const btck_TransactionOutPoint* TKNCKERNEL_WARN_UNUSED_RESULT btck_transaction_input_get_out_point(
    const btck_TransactionInput* transaction_input) TKNCKERNEL_ARG_NONNULL(1);
 ...
 */
TKNCKERNEL_API uint32_t TKNCKERNEL_WARN_UNUSED_RESULT btck_transaction_input_get_sequence(
    const btck_TransactionInput* transaction_input) TKNCKERNEL_ARG_NONNULL(1);

/**
 * Destroy the transaction input.
 */
TKNCKERNEL_API void btck_transaction_input_destroy(btck_TransactionInput* transaction_input);
 ...
 */
TKNCKERNEL_API btck_TransactionOutPoint* TKNCKERNEL_WARN_UNUSED_RESULT btck_transaction_out_point_copy(
    const btck_TransactionOutPoint* transaction_out_point) TKNCKERNEL_ARG_NONNULL(1);
 ...
 */
TKNCKERNEL_API uint32_t TKNCKERNEL_WARN_UNUSED_RESULT btck_transaction_out_point_get_index(
    const btck_TransactionOutPoint* transaction_out_point) TKNCKERNEL_ARG_NONNULL(1);
 ...
 * @return                          The txid.
 */
TKNCKERNEL_API const btck_Txid* TKNCKERNEL_WARN_UNUSED_RESULT btck_transaction_out_point_get_txid(
    const btck_TransactionOutPoint* transaction_out_point) TKNCKERNEL_ARG_NONNULL(1);

/**
 * Destroy the transaction out point.
 */
TKNCKERNEL_API void btck_transaction_out_point_destroy(btck_TransactionOutPoint* transaction_out_point);
 ...
 */
TKNCKERNEL_API btck_Txid* TKNCKERNEL_WARN_UNUSED_RESULT btck_txid_copy(
    const btck_Txid* txid) TKNCKERNEL_ARG_NONNULL(1);
 ...
 */
TKNCKERNEL_API int TKNCKERNEL_WARN_UNUSED_RESULT btck_txid_equals(
    const btck_Txid* txid1, const btck_Txid* txid2) TKNCKERNEL_ARG_NONNULL(1, 2);
 ...
 */
TKNCKERNEL_API void btck_txid_to_bytes(
    const btck_Txid* txid, unsigned char output[32]) TKNCKERNEL_ARG_NONNULL(1, 2);

/**
 * Destroy the txid.
 */
TKNCKERNEL_API void btck_txid_destroy(btck_Txid* txid);
 ...
 */
TKNCKERNEL_API btck_Coin* TKNCKERNEL_WARN_UNUSED_RESULT btck_coin_copy(
    const btck_Coin* coin) TKNCKERNEL_ARG_NONNULL(1);
 ...
 */
TKNCKERNEL_API uint32_t TKNCKERNEL_WARN_UNUSED_RESULT btck_coin_confirmation_height(
    const btck_Coin* coin) TKNCKERNEL_ARG_NONNULL(1);
 ...
 */
TKNCKERNEL_API int TKNCKERNEL_WARN_UNUSED_RESULT btck_coin_is_coinbase(
    const btck_Coin* coin) TKNCKERNEL_ARG_NONNULL(1);
 ...
 */
TKNCKERNEL_API const btck_TransactionOutput* TKNCKERNEL_WARN_UNUSED_RESULT btck_coin_get_output(
    const btck_Coin* coin) TKNCKERNEL_ARG_NONNULL(1);

/**
 * Destroy the coin.
 */
TKNCKERNEL_API void btck_coin_destroy(btck_Coin* coin);
 ...
 */
TKNCKERNEL_API btck_BlockHash* TKNCKERNEL_WARN_UNUSED_RESULT btck_block_hash_create(
    const unsigned char block_hash[32]) TKNCKERNEL_ARG_NONNULL(1);
 ...
 */
TKNCKERNEL_API int TKNCKERNEL_WARN_UNUSED_RESULT btck_block_hash_equals(
    const btck_BlockHash* hash1, const btck_BlockHash* hash2) TKNCKERNEL_ARG_NONNULL(1, 2);
 ...
 */
TKNCKERNEL_API btck_BlockHash* TKNCKERNEL_WARN_UNUSED_RESULT btck_block_hash_copy(
    const btck_BlockHash* block_hash) TKNCKERNEL_ARG_NONNULL(1);
 ...
 */
TKNCKERNEL_API void btck_block_hash_to_bytes(
    const btck_BlockHash* block_hash, unsigned char output[32]) TKNCKERNEL_ARG_NONNULL(1, 2);

/**
 * Destroy the block hash.
 */
TKNCKERNEL_API void btck_block_hash_destroy(btck_BlockHash* block_hash);
 ...
 */
TKNCKERNEL_API btck_BlockHeader* TKNCKERNEL_WARN_UNUSED_RESULT btck_block_header_create(
 ...
 */
TKNCKERNEL_API btck_BlockHeader* TKNCKERNEL_WARN_UNUSED_RESULT btck_block_header_copy(
    const btck_BlockHeader* header) TKNCKERNEL_ARG_NONNULL(1);
 ...
 */
TKNCKERNEL_API btck_BlockHash* TKNCKERNEL_WARN_UNUSED_RESULT btck_block_header_get_hash(
    const btck_BlockHeader* header) TKNCKERNEL_ARG_NONNULL(1);
 ...
 */
TKNCKERNEL_API const btck_BlockHash* TKNCKERNEL_WARN_UNUSED_RESULT btck_block_header_get_prev_hash(
    const btck_BlockHeader* header) TKNCKERNEL_ARG_NONNULL(1);
 ...
 */
TKNCKERNEL_API uint32_t TKNCKERNEL_WARN_UNUSED_RESULT btck_block_header_get_timestamp(
    const btck_BlockHeader* header) TKNCKERNEL_ARG_NONNULL(1);
 ...
 */
TKNCKERNEL_API uint32_t TKNCKERNEL_WARN_UNUSED_RESULT btck_block_header_get_bits(
    const btck_BlockHeader* header) TKNCKERNEL_ARG_NONNULL(1);
 ...
 */
TKNCKERNEL_API int32_t TKNCKERNEL_WARN_UNUSED_RESULT btck_block_header_get_version(
    const btck_BlockHeader* header) TKNCKERNEL_ARG_NONNULL(1);
 ...
 * @return              Nonce
 */
TKNCKERNEL_API uint32_t TKNCKERNEL_WARN_UNUSED_RESULT btck_block_header_get_nonce(
    const btck_BlockHeader* header) TKNCKERNEL_ARG_NONNULL(1);
 ...
 * @return              0 on success.
 */
TKNCKERNEL_API int TKNCKERNEL_WARN_UNUSED_RESULT btck_block_header_to_bytes(
    const btck_BlockHeader* header, unsigned char output[80]) TKNCKERNEL_ARG_NONNULL(1, 2);

/**
 * Destroy the btck_BlockHeader.
 */
TKNCKERNEL_API void btck_block_header_destroy(btck_BlockHeader* header);
