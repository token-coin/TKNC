...
//! Utility function to find any unspent output with a given txid. Expensive if the transaction is not in the cache — it can cause up to MAX_OUTPUTS_PER_BLOCK lookups to the database, so it should be used with care.
