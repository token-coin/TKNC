...
// Generate the signet tx corresponding to the given block. Commits to everything in block except: hashes modified merkle root with signet signature removed, and skips the nonce.
class SignetTxs {
