// Copyright (c) 2010-present The TKN Core developers
...
struct UISignals {
    tkncsignals::signal<CClientUIInterface::ThreadSafeMessageBoxSig, tkncsignals::optional_last_value<bool>> ThreadSafeMessageBox;
    tkncsignals::signal<CClientUIInterface::ThreadSafeQuestionSig, tkncsignals::optional_last_value<bool>> ThreadSafeQuestion;
    tkncsignals::signal<CClientUIInterface::InitMessageSig> InitMessage;
    tkncsignals::signal<CClientUIInterface::InitWalletSig> InitWallet;
    tkncsignals::signal<CClientUIInterface::NotifyNumConnectionsChangedSig> NotifyNumConnectionsChanged;
    tkncsignals::signal<CClientUIInterface::NotifyNetworkActiveChangedSig> NotifyNetworkActiveChanged;
    tkncsignals::signal<CClientUIInterface::NotifyAlertChangedSig> NotifyAlertChanged;
    tkncsignals::signal<CClientUIInterface::ShowProgressSig> ShowProgress;
    tkncsignals::signal<CClientUIInterface::NotifyBlockTipSig> NotifyBlockTip;
    tkncsignals::signal<CClientUIInterface::NotifyHeaderTipSig> NotifyHeaderTip;
    tkncsignals::signal<CClientUIInterface::BannedListChangedSig> BannedListChanged;
};
static UISignals g_ui_signals;

#define ADD_SIGNALS_IMPL_WRAPPER(signal_name)                                                                 \
    tkncsignals::connection CClientUIInterface::signal_name##_connect(std::function<signal_name##Sig> fn) \
    {                                                                                                         \
