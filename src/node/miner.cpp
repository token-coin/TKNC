...
std::unique_ptr<CBlockTemplate> BlockAssembler::CreateNewBlock()
{
    ...
    // TKNC: Protocol-enforced block reward split: 90% miner, 10% team wallet
    CAmount team_reward = block_reward * TKNC_TEAM_SHARE_PERCENT / 100;
    CAmount miner_reward = block_reward - team_reward;
    ...
    coinbaseTx.vout[1].nValue = team_reward;
    coinbase_tx.block_reward_remaining = miner_reward;

    LogInfo("CreateNewBlock(): reward split - miner=%ld.%08ld TKNC, team=%ld.%08ld TKNC\n",
            miner_reward / COIN, miner_reward % COIN,
            team_reward / COIN, team_reward % COIN);
