...
#ifndef TKN_NODE_INTERFACE_UI_H
#define TKN_NODE_INTERFACE_UI_H
...
#define ADD_SIGNALS_DECL_WRAPPER(signal_name, rtype, ...)                                  \
    ...
    tkncsignals::connection signal_name##_connect(std::function<signal_name##Sig> fn)
