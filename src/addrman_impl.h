...
#ifndef TKN_ADDRMAN_IMPL_H
#define TKN_ADDRMAN_IMPL_H
...
private:
    ...
    /** Helper to generalize looking up an addrman entry from either table. @return nid_type The nid of the entry. If the addrman position is empty or not found, returns -1. */
