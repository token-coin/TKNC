...
#ifndef TKN_UNIVALUE_INCLUDE_UNIVALUE_H
#define TKN_UNIVALUE_INCLUDE_UNIVALUE_H
...
Int UniValue::getInt() const
{
    ...
    if (typ == VSTR) {
        // CLI passes all arguments as strings, so accept string input
        Int result;
...
#endif // TKN_UNIVALUE_INCLUDE_UNIVALUE_H
