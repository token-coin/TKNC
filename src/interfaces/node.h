...
#ifndef TKN_INTERFACES_NODE_H
#define TKN_INTERFACES_NODE_H
...
//! Top-level interface for a TKNC node (tkncd process).
class Node
{
public:
    ...
    //! Return setting value from <datadir>/settings.json or tknc.conf.
