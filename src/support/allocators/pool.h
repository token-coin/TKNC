...
#ifndef TKN_SUPPORT_ALLOCATORS_POOL_H
#define TKN_SUPPORT_ALLOCATORS_POOL_H
 ...
 *
 * Example: PoolResource<128, 8>(262144) with 2 deallocated 8-byte blocks and 3
 * 16-byte blocks. m_free_lists[1] serves 8-byte blocks, m_free_lists[2] serves
 * 16-byte blocks. Blocks are carved from m_allocated_chunks (each 262144 bytes).
 * When m_available_memory_it reaches the end, a new chunk is allocated.
 */
...
#endif // TKN_SUPPORT_ALLOCATORS_POOL_H
